  ...
  const handleJoinSession = async (code = null) => {
    ...
    try {
      ...
      if (err.code === 'VALIDATION_ERROR') {
        ...
        setJoinError("Meeting session not found");
      } else {
        setJoinError(err.message || "Meeting session not found");
      }
    }
  };
            ...
            <TiltCard>
              <div className="action-card secondary connect-card" onClick={(e) => {
                ...
                <div className="join-input-group">
                  <input
                    type="text"
                    placeholder="Enter gathering code"
                    value={joinCode}
                    onChange={(e) => {
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ 
              ...
              Are you sure you want to clear your gathering history? This will only remove them from your view and cannot be undone.
            </p>
